...
class ActionConfig(BaseModel):
    ...
    vmix_target_input_key: Optional[str] = None
...
class TriggerRuleBase(BaseModel):
    ...
    vmix_input_key: Optional[str] = Field(
        None, description="vMix input UUID key (immune to rename and reorder)"
    )
    ...
    vmix_target_input_key: Optional[str] = Field(
        None, description="vMix target input UUID key"
    )
...
class TriggerRuleUpdate(BaseModel):
    ...
    vmix_input_key: Optional[str] = None
