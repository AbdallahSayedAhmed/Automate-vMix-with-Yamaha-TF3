...
class TriggerRule(Base):
    ...
    vmix_input_key = Column(String, nullable=True)   # e.g., 'UUID-1234'
    ...
    vmix_target_input_key = Column(String, nullable=True) # Target input UUID for SetVolume
...
class DuckGroupAction(Base):
    ...
    vmix_target_input_key = Column(String, nullable=True)
