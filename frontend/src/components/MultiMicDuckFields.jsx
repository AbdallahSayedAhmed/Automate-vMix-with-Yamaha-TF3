...
export function MultiMicDuckFields({
  ...
  const legacyActionFromMember = (member) => ({
    ...
    vmix_target_input_key: member.vmix_target_input_key ?? null,
  ...
  const withPrimaryActionFields = (member, actions) => {
    ...
    return {
      ...
      vmix_target_input_key: first.vmix_target_input_key ?? null,
          ...
          return (
            ...
            >
              ...
              <MultiActionFields
                ...
                onChange={(_, newActions) =>
                  setMemberActions(idx, newActions)
                }
