...
import { PresetEventCommandForm } from "./PresetEventCommandForm";
import {
  formatListenDetail,
  formatCommandDetail,
  presetFormFromDefaults,
...
function PresetSummary({ form }) {
  ...
  return (
    <p
      className="text-[10px] mt-1 leading-snug truncate"
      style={{ color: "#5A6278" }}
    >
...
export function QuickPresetsPanel({
  ...
  const patchAddForm = (field, value) =>
  ...
  const saveEdit = () => {
    ...
    onUpdate?.(editingId, {
      label: editName.trim(),
      form: { ...editForm, name: editName.trim() },
    });
    cancelEdit();
  };
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ color: "#5A6278" }}
                  >
                    Pick event &amp; command from lists — no need to memorize
                    paths
                  </p>
                </div>
              </div>
                    ...
                    {editingId === p.id ? (
                      ...
                      <>
                        ...
                        <button
                          ...
                          onClick={() => startEdit(p)}
                          style={{
                            color: editingId === p.id ? "#20D9FF" : "#5A6278",
                          }}
                          title="Edit event & command"
                        >
                          <Pencil size={13} />
                        </button>
                        <button
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  onClick={() =>
                    addFormOpen ? saveNewPreset() : openAddForm()
                  }
                ...
                >
                  {addFormOpen ? (
                    ...
                    <>
                      <ChevronDown size={14} /> Choose Event
                    </>
                  )}
                </button>
              </div>
                  ...
                  <SlideForm>
                    ...
                    <button
                      ...
                      style={{
                        background: "rgba(246,180,75,0.2)",
                        color: "#F6B44B",
                        border: "1px solid rgba(246,180,75,0.35)",
                      }}
                    >
