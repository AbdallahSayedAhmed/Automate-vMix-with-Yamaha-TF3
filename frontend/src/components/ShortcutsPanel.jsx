...
import { findShortcutConflict } from "../hooks/useAppPreferences";
...
export function ShortcutsPanel({
  ...
  const categories = [
    ...new Set(Object.values(shortcuts).map((s) => s.category)),
  ];
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h2 className="font-bold" style={{ color: "#D8DCE6" }}>
                  Keyboard Shortcuts
                </h2>
              </div>
              <div className="flex items-center gap-2">
            ...
            >
              <label className="flex items-center justify-between cursor-pointer">
                <span className="text-sm" style={{ color: "#8B93A8" }}>
                  Show field & command descriptions
                </span>
                <input
                  type="checkbox"
                  checked={showFieldHints}
            ...
            {editingId && (
              <div
                ...
                style={{
                  ...
                  borderBottom: "1px solid rgba(32,217,255,0.15)",
                }}
              >
                <span className="text-sm text-live-cyan">
            ...
            <p
              className="text-center text-[10px] py-3 shrink-0"
              style={{ color: "#5A6278" }}
            >
