...
export function SettingsModal({ isOpen, onClose }) {
  ...
  useEffect(() => {
    ...
    const loadTimer = setTimeout(loadSettings, 0);
    return () => {
      cancelled = true;
          ...
          >
            ...
            >
              ...
              <button
                ...
                style={{ color: "#5A6278" }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = "#D8DCE6";
                }}
                onMouseLeave={(e) => {
            ...
            <form onSubmit={handleSave} className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                <h3
                  ...
                  style={{
                    color: "#20D9FF",
                    borderBottom: "1px solid rgba(32,217,255,0.12)",
                  }}
                >
                  <Server size={14} />
                  vMix Engine
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      style={inputStyle}
                      onFocus={(e) => {
                        e.target.style.borderColor = "rgba(32,217,255,0.4)";
                      }}
                      onBlur={(e) => {
              ...
              <div className="space-y-4">
                <h3
                  ...
                  style={{
                    color: "#39E58C",
                    borderBottom: "1px solid rgba(57,229,140,0.12)",
                  }}
                >
                  <Speaker size={14} />
                  Yamaha TF3
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      style={inputStyle}
                      onFocus={(e) => {
                        e.target.style.borderColor = "rgba(57,229,140,0.4)";
                      }}
                      onBlur={(e) => {
                        e.target.style.borderColor = "rgba(255,255,255,0.08)";
                      }}
              ...
              >
                ...
                <button
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(32,217,255,0.9), rgba(32,217,255,0.7))",
                    color: "#070A0F",
