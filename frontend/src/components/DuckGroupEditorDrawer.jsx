...
function MemberActions({ member, memberIdx, onChangeMember, showHints }) {
  const updateAction = (ai, field, value) => {
    const actions = member.actions.map((a, i) =>
      i === ai ? { ...a, [field]: value } : a,
    );
  ...
  return (
    <div
      ...
      style={{ borderColor: "rgba(57,229,140,0.25)" }}
    >
            ...
            <div className="grid grid-cols-2 gap-2">
              <Field label="Target">
                <select
                  ...
                  onChange={(e) =>
                    updateAction(ai, "action_target", e.target.value)
                  }
                  style={inputStyle}
                >
              ...
              {action.action_target === "yamaha" ? (
                <Field label="Command">
                  <select
                    value={cmd}
                    onChange={(e) =>
                      updateAction(ai, "yamaha_command", e.target.value)
                    }
                    style={inputStyle}
                  >
                ...
                <Field label="vMix Function">
                  <select
                    ...
                    onChange={(e) =>
                      updateAction(ai, "vmix_function", e.target.value)
                    }
                    style={inputStyle}
                  >
              ...
              {action.action_target === "vmix" &&
                action.vmix_function === "SetVolume" && (
              ...
              <Field
                label="Duck Value"
                hint={showHints ? "e.g. -2500 for -25dB, or 0 for mute" : null}
              >
                <input
                  type="text"
                  value={action.parameter_value || ""}
                  onChange={(e) =>
                    updateAction(ai, "parameter_value", e.target.value)
                  }
                  style={inputStyle}
                />
              </Field>
...
export function DuckGroupEditorDrawer({
  ...
  useEffect(() => {
    ...
    const resetExpanded = setTimeout(() => setExpanded({}), 0);
    return () => clearTimeout(resetExpanded);
  }, [isOpen, isNew]);
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4">
              ...
              <Field
                ...
                hint={
                  showFieldHints
                    ? "How long all mics must be quiet before restore (per target)."
                    : null
                }
              >
                <input
              ...
              >
                <button type="button" onClick={() => copyAll(0)} style={btnSm}>
                  <Copy size={11} className="inline mr-1" /> Copy All Settings
                  (row 1)
                </button>
                <button
                  type="button"
                ...
                >
                  <ClipboardPaste size={11} className="inline mr-1" /> Paste All
                  to Every Channel
                </button>
                {allClip && (
                  <span
                            ...
                            <td key={field} className="py-2 pr-1">
                              <div className="flex items-center gap-0.5">
                                ...
                                <PasteBtn
                                  ...
                                  disabled={
                                    !fieldClip || fieldClip.field !== field
                                  }
