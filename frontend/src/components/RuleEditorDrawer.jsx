...
import { VMIX_EVENT_LABELS, VMIX_EVENT_INFO } from "../constants/ruleConfig";
...
import { DEFAULT_DUCK_MEMBER } from "../constants/duckGroupConfig";
...
export function RuleEditorDrawer({
  ...
  useEffect(() => {
    ...
    const resetTab = setTimeout(() => setTab("listen"), 0);
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4">
                    ...
                    <div className="flex rounded-lg overflow-hidden w-fit">
                      ...
                      <SegmentBtn
                        ...
                        onClick={() => {
                          ...
                          onChange(
                            "silence_timeout_ms",
                            form.silence_timeout_ms ?? 3000,
                          );
                          onChange(
                            "parameter_value",
                            form.parameter_value?.includes(",")
                              ? form.parameter_value
                              : "700,700",
                          );
                          onChange(
                            "duck_members",
                            form.duck_members?.length
                              ? form.duck_members
                              : [{ ...DEFAULT_DUCK_MEMBER }],
                          );
                        }}
                      ...
                      >
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            onChange("vmix_input_key", inp?.key || "");
                          }}
                          style={inputStyle}
                        >
              ...
              {tab === "command" && (
                <div className="space-y-4 pb-20">
                  {form.listen_source === "yamaha" &&
                  form.trigger_event === "YamahaMeter" &&
                  form.is_multi_duck ? (
                    <MultiMicDuckFields
                      mode="command"
                      form={form}
                    ...
                    <MultiActionFields form={form} onChange={onChange} vmixInputs={vmixInputs} />
                  )}
                </div>
              )}
